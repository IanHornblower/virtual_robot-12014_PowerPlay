...
public class FollowTrajectoryHoloPose extends Action {
    ...
    public FollowTrajectoryHoloPose(Robot robot, Trajectory trajectory, double radius) {
        this.robot = robot;
        this.trajectory = trajectory;
        this.radius = radius;
    }

    public FollowTrajectoryHoloPose(Robot robot, Trajectory trajectory, double radius, boolean reversed) {
        this.robot = robot;
        this.trajectory = trajectory;
        this.radius = radius;
    ...
    public FollowTrajectoryHoloPose(Robot robot, Trajectory trajectory, double radius, double timeout) {
        this.robot = robot;
        this.trajectory = trajectory;
        this.radius = radius;
    ...
    public FollowTrajectoryHoloPose(Robot robot, Trajectory trajectory, double radius, boolean reversed, double timeout) {
        this.robot = robot;
        this.trajectory = trajectory;
        this.radius = radius;
        this.reversed = reversed;
